<p align="center">
  <img src="logo.png" alt="WhatsApp Forensicator Logo" width="150"/>
</p>
...
<p align="center">
  <img src="https://img.shields.io/badge/Platform-Windows-blue?style=for-the-badge&logo=windows" alt="WhatsApp Forensics Tool for Windows">
  <img src="https://img.shields.io/badge/Version-2.0-success?style=for-the-badge" alt="Version 2.0">
  <img src="https://img.shields.io/badge/License-Commercial-orange?style=for-the-badge" alt="Commercial License">
  <img src="https://img.shields.io/badge/Decrypt-crypt12%20%7C%20crypt14%20%7C%20crypt15-25D366?style=for-the-badge" alt="Decrypt crypt12 crypt14 crypt15">
</p>
...
```mermaid
flowchart LR
    A["📱 Connect Device<br/>USB / TCP-IP"] --> B["📦 Extract Databases<br/>Root / Non-Root"]
    B --> C["🔓 Decrypt<br/>crypt12 / crypt14 / crypt15"]
    C --> D{"🔍 Analyze"}
    D --> E["💬 Chat Viewer"]
    D --> F["📞 Call Analysis"]
    D --> G["📡 VOIP Analysis"]
    D --> H["🖼️ Media Decryption"]
    E --> I["📊 Export Report<br/>TXT / CSV / HTML / JSON"]
    F --> I
    G --> I
    H --> I
```
...
```mermaid
flowchart LR
    A["▶️ Start Capture"] --> B["📞 WhatsApp Call<br/>Incoming / Outgoing"]
    B --> C["🛰️ Capture Live Packets"]
    C --> D["🌐 Extract Remote IP & Ports"]
    D --> E["📍 IP Geolocation Lookup"]
    E --> F["🗺️ Plot Location on Map"]
    F --> G["⏹️ Stop & Export Findings"]
```
...
<p align="center">
  <a href="https://wa.me/916204636414">
    <img src="https://img.shields.io/badge/WhatsApp-%2B91%206204636414-25D366?style=for-the-badge&logo=whatsapp&logoColor=white" alt="Contact on WhatsApp +91 6204636414">
  </a>
</p>
